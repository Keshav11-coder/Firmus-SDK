 ...
 *  Legacy cascaded control strategy - legacy.h
...
[[deprecated("These interfaces are legacy Cascade-centric abstractions. Use the new IBodyControlLayer and IBodyController framework for flexible, modular, and extensible control pipelines.")]] struct PIDGains
{
...
[[deprecated("These interfaces are legacy Cascade-centric abstractions. Use the new IBodyControlLayer and IBodyController framework for flexible, modular, and extensible control pipelines.")]] class IAttitude
{
public:
...
[[deprecated("These interfaces are legacy Cascade-centric abstractions. Use the new IBodyControlLayer and IBodyController framework for flexible, modular, and extensible control pipelines.")]] class IVelocity
{
public:
...
[[deprecated("These interfaces are legacy Cascade-centric abstractions. Use the new IBodyControlLayer and IBodyController framework for flexible, modular, and extensible control pipelines.")]] class IPosition
{
public:
...
[[deprecated("These interfaces are legacy Cascade-centric abstractions. Use the new IBodyControlLayer and IBodyController framework for flexible, modular, and extensible control pipelines.")]] class IOrchestrator
{
public:
...
[[deprecated("These interfaces are legacy Cascade-centric abstractions. Use the new IBodyControlLayer and IBodyController framework for flexible, modular, and extensible control pipelines.")]] class Attitude : public IAttitude
{
private:
    // PID Controllers
...
[[deprecated("These interfaces are legacy Cascade-centric abstractions. Use the new IBodyControlLayer and IBodyController framework for flexible, modular, and extensible control pipelines.")]] class Velocity : public IVelocity
{
private:
...
[[deprecated("These interfaces are legacy Cascade-centric abstractions. Use the new IBodyControlLayer and IBodyController framework for flexible, modular, and extensible control pipelines.")]] class Orchestrator : public IOrchestrator
{
private:
